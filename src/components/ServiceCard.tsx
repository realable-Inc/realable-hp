  ...
  return (
    <Link href={`/services/${service.id}`} className="h-full">
      <div className="group bg-white rounded-xl shadow-md hover:shadow-xl border border-slate-200 overflow-hidden transition-all duration-300 hover:scale-[1.02] cursor-pointer h-full flex flex-col">
        {/* Image Section */}
        <div className="relative h-36 bg-white overflow-hidden p-4">
          {service.overviewImage ? (
            ...
            <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-emerald-500 to-emerald-600">
              <div className="text-white text-center">
                ...
                <h4 className="text-sm font-medium opacity-90">AIサービス</h4>
              </div>
            </div>
          )}
        </div>
        ...
        <div className="p-6 flex-1 flex flex-col border-t border-slate-200">
          ...
          <p className="text-slate-600 leading-relaxed mb-4 flex-1 text-sm">
            {service.description}
          </p>
